...
let
  ...
  machine-dir = nix-dir + "/machines/NGFAir12";
...
in {
  ...
  users.users.taylor.name = "taylor";
  users.users.taylor.home = "/Users/taylor";
  home-manager.users.taylor = (import "${machine-dir}/home.nix");
